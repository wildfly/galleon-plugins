 ...
 */
class FeaturePackBuildModelParser34 implements XMLElementReader<WildFlyFeaturePackBuild.Builder> {

    public static final String NAMESPACE = "urn:wildfly:feature-pack-build:3.4";
