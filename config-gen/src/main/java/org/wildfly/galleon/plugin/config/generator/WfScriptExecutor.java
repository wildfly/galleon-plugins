...
public abstract class WfScriptExecutor implements ForkedEmbeddedUtil.ForkCallback {
    ...
    public void setFork(boolean fork) {
        this.forkEmbedded = fork;
    }

    public void execute(ProvisioningRuntime runtime) throws ProvisioningException {
    ...
    protected abstract void doExecute(ProvisioningRuntime runtime) throws ProvisioningException;
